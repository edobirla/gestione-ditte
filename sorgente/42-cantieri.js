...
function schedaCantiereAnagrafica(c){
  ...
  return html`<div class="griglia due"><div class="scheda"><h3>Dati del cantiere</h3><div class="campi">
    ...
    ${campo('Inizio lavori',c.dataInizio,fData)}${campo('Fine lavori',c.dataFine,fData)}${c.periodoTesto?campo('Periodo (testo)',c.periodoTesto):''}
    ...
    <div class="sezione-titolo">Denuncia di apertura cantiere</div><div class="campi">${campo('Data',c.denuncia.data,fData)}${campo('Periodo',c.denuncia.dal?fData(c.denuncia.dal)+' → '+fData(c.denuncia.al):null)}${campo('Importo complessivo lavori',c.denuncia.importoComplessivo,fEuro)}${campo('Importo dell\u2019impresa',c.denuncia.importoPavimass,fEuro)}</div>
