...
const TIPI_DOCUMENTO_INIZIALI=[
  ...
  {id:'primo_soccorso',nome:'Primo Soccorso 16h',ambito:'persona',validitaMesi:36,obbligatorio:'primoSoccorso',bloccaIdoneita:false,categoria:'formazione',sinonimi:['primo soccorso','pronto soccorso','ps','p.s.']},
  {id:'antincendio_2',nome:'Antincendio Livello 2',ambito:'persona',validitaMesi:60,obbligatorio:'antincendio',bloccaIdoneita:false,categoria:'formazione',sinonimi:['antincendio','prevenzione incendi','livello 2','rischio medio']},
  ...
  {id:'nomina_persona',nome:'Nomina Preposto / Antincendio / Primo Soccorso',ambito:'persona',validitaMesi:null,obbligatorio:'ruolo',bloccaIdoneita:false,soloCantiere:true,categoria:'nomina',sinonimi:['nomina','nomina preposto','nomina antincendio','nomina primo soccorso','designazione']},
