...
function tabella(opz){
  // una tabella cliccabile senza id riceverebbe i clic dell'ultima tabella disegnata: se ne dà uno
  if(opz.onRiga&&!opz.id) opz.id='cliccabile-'+tabelleCliccabili.length;
