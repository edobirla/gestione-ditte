...
VISTE.preventivi=function(r){
  ...
  return html`<div class="testata"><div><h1>Preventivi</h1><div class="sotto">${stato.preventivi.length} preventivi · ${stato.listino.length} voci di listino</div></div><div class="azioni"><button class="pulsante" data-azione="preventivo-importa-voci" title="Carica il capitolato o il computo del cliente (Excel o PDF): le voci finiscono in un preventivo dell’impresa">${icona('carica')}Importa voci dal cliente</button><a class="pulsante" href="#/preventivi/listino">${icona('elenco')}Listino</a><button class="pulsante primario" data-azione="preventivo-nuovo">${icona('piu')}Nuovo preventivo</button></div></div>
